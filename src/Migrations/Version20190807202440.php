 ...
 */
final class Version20190807202440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_usergroup (user_group_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_4A84F5F31ED93D47 (user_group_id), INDEX IDX_4A84F5F3A76ED395 (user_id), PRIMARY KEY(user_group_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_usergroup DROP FOREIGN KEY FK_4A84F5F31ED93D47');
